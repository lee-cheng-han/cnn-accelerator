...
root = Path(os.getcwd())
workspace = root / "build" / "vitis_ws_v2"
xsa_file = root / "build" / "arty_z7_20_cnn_v2" / "arty_z7_20_cnn_v2.xsa"

platform_name = "arty_z7_20_cnn_v2_platform"
app_name = "cnn_v2_baremetal"
...
if workspace.exists():
    print(f"Removing old Vitis v2 workspace: {workspace}")
...
src_main = root / "software" / "zynq_v2_baremetal" / "main.c"
...
src_generated = root / "software" / "zynq_v2_baremetal" / "generated"
...
if not elf.exists():
    raise RuntimeError(f"Vitis v2 app build did not produce ELF: {elf}")

print("")
print("Vitis v2 bare-metal app build done.")
print("ELF:")
print(elf)
print("")
