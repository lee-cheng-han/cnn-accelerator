#!/usr/bin/env python3
"""Summarize v2 PC/PK post-synthesis timing and utilization reports."""
...
def render_markdown(results: list[Result]) -> str:
    ...
    lines = [
        ...
        "",
        "These are out-of-context post-synthesis estimates for the v2 parallel "
    ...
    lines.extend(
        [
            "",
            "The full v2 AXI top remains dominated by simulation-oriented tensor "
            ...
            "run the full v2 regression and confirm post-route timing in the "
            "dedicated v2 block design.",
            "",
            "Regenerate:",
            "",
            "```bash",
