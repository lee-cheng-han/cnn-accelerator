...
set top_name v2_compute_slice_benchmark_top
...
if {[info exists ::env(OUT_DIR)]} {
  ...
  set out_dir "build/v2_synth_sweep/pc${pc}_pk${pk}"
}
...
set sources [list \
  ...
  rtl/compute_v2/v2_compute_slice_benchmark_top.sv \
]
...
read_xdc constraints/v2_compute_slice_ooc.xdc
...
write_checkpoint -force "$out_dir/v2_pc${pc}_pk${pk}_synth.dcp"
...
puts "============================================================"
puts "V2 synthesis complete: PC=$pc PK=$pk"
puts "Part: $part_name"
