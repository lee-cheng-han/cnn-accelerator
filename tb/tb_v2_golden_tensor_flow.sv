...
module tb_v2_golden_tensor_flow;
  ...
  initial begin
    ...
    run_case("python_golden_single_layer_1x1", "../../build/v2_golden/single_layer_1x1");
    run_case("python_golden_single_layer_3x3", "../../build/v2_golden/single_layer_3x3");

    $display("[PASS] tb_v2_golden_tensor_flow tests=%0d", tests);
    $finish;
  end
